        ...
        <div className="container">
          <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div className="col-12 col-lg-6 col-xl-5">
              <img className="img-fluid rounded" loading="lazy" src="https://c8.alamy.com/comp/2C7YYK8/strawberry-fruit-in-a-bowl-against-dark-background-2C7YYK8.jpg" alt="About 1" />
            </div>
